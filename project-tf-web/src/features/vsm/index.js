  ...
  "templates": [
    {
      ...
      onItemRender: ({ context: itemConfig }) => {
        return <div tw="bg-white overflow-hidden border border-gray-300 divide-y divide-gray-300 h-full hover:border-gray-500 cursor-pointer">
          <div tw="bg-gray-200 px-4 py-2">
            <div tw="flex justify-between">
              <div tw="text-xs font-medium">
                <div>{ itemConfig.title }</div>
              </div>
            </div>
          </div>
          <div tw="p-4">
            <div tw="text-xs mb-3">Instance: 1</div>
            <div tw="text-xs">Triggered by changes</div>
            <div tw="flex -mx-1">
              <div tw="text-xs text-white bg-green-500 px-3 py-1 m-1">
                Plan
              </div>
              <div tw="text-xs text-white bg-green-500 px-3 py-1 m-1">
                Apply
