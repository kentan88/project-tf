    ...
    <>
            ...
            <form action="#" method="POST">
              <div tw="shadow sm:rounded-md sm:overflow-hidden">
                <div tw="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div>
                    <label tw="block text-sm font-medium text-gray-700">Cover photo</label>
                    <div tw="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div tw="space-y-1 text-center">
                        ...
                        <p tw="text-xs text-gray-500">PNG, JPG, GIF up to 10MB</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div tw="md:grid md:grid-cols-3 md:gap-6">
          <div tw="md:col-span-1">
            <div tw="px-4 sm:px-0">
              ...
              <p tw="mt-1 text-sm text-gray-600">Use a permanent address where you can receive mail.</p>
            </div>
          </div>
          <div tw="mt-5 md:mt-0 md:col-span-2">
            <form action="#" method="POST">
                ...
                <div tw="px-4 py-5 bg-white sm:p-6">
                  <div tw="grid grid-cols-6 gap-6">
                    <div tw="col-span-6 sm:col-span-3">
                      <label htmlFor="first_name" tw="block text-sm font-medium text-gray-700">
                        First name
                      </label>
                      <input
                        type="text"
                    ...
                    <div tw="col-span-6 sm:col-span-3">
                      <label htmlFor="last_name" tw="block text-sm font-medium text-gray-700">
                        Last name
                      </label>
                      <input
                        type="text"
                    ...
                    <div tw="col-span-6 sm:col-span-4">
                      <label htmlFor="email_address" tw="block text-sm font-medium text-gray-700">
                        Email address
                      </label>
                      <input
                        type="text"
                    ...
                    <div tw="col-span-6 sm:col-span-3">
                      ...
                      <select
                        ...
                        tw="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
                    ...
                    <div tw="col-span-6">
                      <label htmlFor="street_address" tw="block text-sm font-medium text-gray-700">
                        Street address
                      </label>
                      <input
                        type="text"
                    ...
                    <div tw="col-span-6 sm:col-span-3 lg:col-span-2">
                      <label htmlFor="state" tw="block text-sm font-medium text-gray-700">
                        State / Province
                      </label>
                      <input
                        type="text"
                    ...
                    <div tw="col-span-6 sm:col-span-3 lg:col-span-2">
                      <label htmlFor="postal_code" tw="block text-sm font-medium text-gray-700">
                        ZIP / Postal
                      </label>
                      <input
                        type="text"
      ...
      <div tw="mt-10 sm:mt-0">
        <div tw="md:grid md:grid-cols-3 md:gap-6">
          <div tw="md:col-span-1">
            <div tw="px-4 sm:px-0">
              <h3 tw="text-lg font-medium leading-6 text-gray-900">Notifications</h3>
              <p tw="mt-1 text-sm text-gray-600">Decide which communications you'd like to receive and how.</p>
            </div>
          </div>
          <div tw="mt-5 md:mt-0 md:col-span-2">
            <form action="#" method="POST">
              <div tw="shadow overflow-hidden sm:rounded-md">
                <div tw="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <fieldset>
                    <legend tw="text-base font-medium text-gray-900">By Email</legend>
                    <div tw="mt-4 space-y-4">
                      <div tw="flex items-start">
                        ...
                        <div tw="ml-3 text-sm">
                          ...
                          <p tw="text-gray-500">Get notified when someones posts a comment on a posting.</p>
                        </div>
                      </div>
                      <div tw="flex items-start">
                        <div tw="flex items-center h-5">
                        ...
                        <div tw="ml-3 text-sm">
                          ...
                          <p tw="text-gray-500">Get notified when a candidate applies for a job.</p>
                        </div>
                      </div>
                      <div tw="flex items-start">
                        <div tw="flex items-center h-5">
                        ...
                        <div tw="ml-3 text-sm">
                          ...
                          <p tw="text-gray-500">Get notified when a candidate accepts or rejects an offer.</p>
                        </div>
                      </div>
                    </div>
                  </fieldset>
                  <fieldset>
                    <div>
                      <legend tw="text-base font-medium text-gray-900">Push Notifications</legend>
                      <p tw="text-sm text-gray-500">These are delivered via SMS to your mobile phone.</p>
                    </div>
                    <div tw="mt-4 space-y-4">
                      <div tw="flex items-center">
                        ...
                        />
                        <label htmlFor="push_everything" tw="ml-3 block text-sm font-medium text-gray-700">
                          Everything
                        </label>
                      </div>
                      <div tw="flex items-center">
                        <input
                          ...
                          tw="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                        />
                        <label htmlFor="push_email" tw="ml-3 block text-sm font-medium text-gray-700">
                          Same as email
                        </label>
                      </div>
                      <div tw="flex items-center">
                        <input
                          ...
                          tw="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                        />
                        <label htmlFor="push_nothing" tw="ml-3 block text-sm font-medium text-gray-700">
